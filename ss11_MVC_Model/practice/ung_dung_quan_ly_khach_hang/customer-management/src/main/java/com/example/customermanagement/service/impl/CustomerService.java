...
public class CustomerService implements ICustomerService {
    ...
    static {
        ...
        customers.put(4, new Customer(4, "Adam", "adam@codegym.vn", "vvv"));
        customers.put(5, new Customer(5, "Sophia", "sophia@codegym.vn", "vvv"));
        customers.put(6, new Customer(6, "Rose", "rose@codegym.vn", "vvv"));
    }
